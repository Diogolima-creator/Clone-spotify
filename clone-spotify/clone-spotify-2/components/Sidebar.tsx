...
export const Sidebar = () => {
    ...
    useEffect(() => {
        if(spotifyApi.getAccessToken()){
            spotifyApi.getUserPlaylists().then((data: { body: { items: SetStateAction<never[]>; }; })=>{
    ...
    lg:text-sm text-xs sm:max-w-w[12rem] lg:max-w-[15rem]
    ...
    ">
        ...
        <button className="flex items-center space-x-2 
            ...
            <hr className="border-t-[0.1px] border-gray-900"/>
             ...
             {playlists.map((playlist: Item,item) => (
